class BookingsController < ApplicationController
  ...
  def accept
    if @booking.update(status: "approved")
      ...
      redirect_to account_overview_user_path(current_user), alert: "Failed to approve booking"
    end
  end
  ...
  def reject
    if @booking.update(status: "rejected")
      ...
      redirect_to account_overview_user_path(current_user), alert: "Failed to reject booking"
    end
  end 
